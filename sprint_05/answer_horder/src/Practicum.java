...
public class Practicum {
    ...
    public static void main(String[] args) {
        ...
        elephantAnswer.printSmart();  // объект elephantAnswer ...ответ на вопрос...
        ...
        elephantVolumeQuestion.printSmart();  /// ...сложные вопросы...
        ...
        answers.add(elephantAnswer); // добавление отета на вопрос про слона в лучшие ответы
